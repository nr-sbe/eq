...
class ImpactFX{
 ...
 event(e,time){if(e.type!=='cast'||e.sword||e.element===2)return;const interval=[.17,.25,.3,.3,.4][e.element];if(time-this.last[e.element]<interval&&!e.critical)return;this.last[e.element]=time;this.jobs.push({...e,birth:time,life:e.element===0?.6:e.element===3?1.1:.9,power:Math.min(1.8,1+(e.tier-1)*.075+(e.specialization?.control||0)*.15)});if(this.jobs.length>24)this.jobs.shift();}
