...
class MusicDirector{
 ...
 gain(d,value){if(!d||d.disposed)return;d.value=value;d.gain.gain.setTargetAtTime(value*({"asian-drums.mp3": 1, "western.mp3": 0.54, "neon.mp3": 0.4, "scarab.mp3": 0.64, "long-dark.mp3": 0.8, "old-ones.ogg": 1, "ascension.mp3": 0.95, "japan-battle.mp3": 0.54, "west-battle.mp3": 0.316, "ai-fight.mp3": 0.46, "egypt-battle.mp3": 0.387, "legionnaire.mp3": 0.34, "gothic-battle.mp3": 0.54, "heavens-battle.mp3": 0.3}[d.file]||1),this.owner.context.currentTime,.025);}
