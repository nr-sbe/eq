...
| neon.mp3 | **Neon** — Scott Buckley, www.scottbuckley.com.au | [Original](https://www.scottbuckley.com.au/library/neon/), [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/); downloaded from [free-stock-music.com](https://www.free-stock-music.com/scott-buckley-neon.html). Royalty Free Music by free-stock-music.com. |
| ai-fight.mp3 | **AI Fight** — Alexander Ehlers | [Cyberpunk Pack](https://opengameart.org/content/t-t-free-cyberpunk-pack-2), [CC0](https://creativecommons.org/publicdomain/zero/1.0/) |
...
Modification record: musical arrangements are uncut. Whole recordings loop in the media player. Runtime gain changes and 2.5-second equal-power fades enter combat and change worlds; four-second fades return after six seconds without an active encounter. Neon and AI Fight use 160 kbps stereo MP3 exports, a 45 Hz high-pass, source gains of 0.8 and 0.45, and a 0.7-second fade at the beginning; full duration is retained. Runtime gains are 0.4 and 0.46. Other recordings are unedited. Wikimedia's supplied MP3 transcode is used for Legionnaire; the original Ogg container of The Old Ones is renamed `.ogg` for serving. Source locations, byte lengths and SHA-256 hashes are in `assets/audio/sources.json`.
