...
const files=['index.html','style.css','three.min.js','model-loader.js','hero-asset.js','campaign.js','sword-motion.js','character.js','effects.js','mastery-fx.js','audio.js','cinematic.js','keyboard.js','touch.js','world.js','damage-numbers.js','game.js','ASSET-CREDITS.md','THREE-LICENSE.txt','LICENSE'];
