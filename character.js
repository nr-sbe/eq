...
(()=>{
 ...
 function createActionHero(){
  const root=new T.Group(),sword=weapon();root.add(sword.root);sword.root.visible=false;let template=null,clips=null,model=null,mixer=null,current=null,actions={},last=0,heldPose=null,bones={},scale=1;const aimY=new T.Vector3(0,1,0),v=new T.Vector3(),q=new T.Quaternion(),parentQ=new T.Quaternion();
